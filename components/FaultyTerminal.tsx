...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    // Set background color to match app theme (or keep transparent if shader handles it)
    // Using a very dark color similar to #0B0F0E
    gl.clearColor(11/255, 15/255, 14/255, 1);
    ...
    const update = (t: number) => {
      ...
      if (pageLoadAnimation && loadAnimationStartRef.current > 0) {
        ...
        if (programRef.current) programRef.current.uniforms.uPageLoadProgress.value = progress;
      }
